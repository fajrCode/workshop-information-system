...
<head>
  ...
  <title>Syalalala Register</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="" method="$_POST" class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <button name="resetPassword" class="btn btn-primary w-100" type="submit">Reset Password</button>
                    </div>
                    <div class="col-12">
